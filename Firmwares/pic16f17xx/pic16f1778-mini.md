...
- faire la difference avec le  langage
...
- [3.EUSART - ADC - SWITCHS - ROTARY ENCODER.](#3eusart---adc---switchs---rotary-encoder)
- [4.LCD - ADC - SWITCHS - ROTARY ENCODER.](#4lcd---adc---switchs---rotary-encoder)
...
## 3.EUSART - ADC - SWITCHS - ROTARY ENCODER.

```as

```

## 4.LCD - ADC - SWITCHS - ROTARY ENCODER.
